...
| 4  | 시제품(Prototype) 완료  | 주요 기능 포함한 시제품 개발 완료        | 2025-07-28 |
| 5  | 전체 기능 개발 완료        | 모든 기능 코딩 및 내부 테스트 종료       | 2025-08-25 |
| 6  | 시스템 통합 테스트(ST) 완료  | 모든 모듈 통합 후 종합 테스트 완료       | 2025-09-10 |
| 7  | 사용자 수용 테스트(UAT) 완료 | 실제 사용자들이 시스템 테스트 완료        | 2025-09-20 |
| 8  | 최종 점검        | 사용자 피드백 반영 후 최종 제품 승인      | 2025-06-22 |
| 9 | 시스템 정식 개발완료 및 배포         | 운영 서버로의 배포 및 서비스 시작        | 2025-06-23 |
