...
#### 교수님의 조언 : 잘 와닿지 않음 -> 해결됨 : 이유 : 이 프로젝트를 하게 된 계기 및 배경이 있어야 내가 잘 와닿을 수 있을 것 같다. 라고 말씀하심. ex:) 탕수육 부먹 찍먹을 예로 드심( 다들 각자의 그럴싸한 이유가 있음)
#### 요구사항 정의서 만들어야 됨 : 나 , 이 앱을 사용하는 이용자 , AI 에서의 ... . 어떻게 만들어야할지 구상해야함

| 날짜    | 마일스톤 내용                   |
| ----- | ------------------------- |
| 05.25 | UI/UX 디자인 및 플로우차트 완료      |
| 06.02 | 페이지 구현 완료 및 기능 구현 시작      |
| 06.16 | 기능 구현 완료, 언어변환 및 광고 처리 시작 |
| 06.23 | 언어변환 페이지 및 광고 작업 완료       |
| 06.30 | 전체 프로젝트 마무리 및 최종 점검 완료    |
 마일스톤 이런식으로 구성 
